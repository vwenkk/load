...
func (gu *GroupUpdate) SetStatus(u uint8) *GroupUpdate {
...
func (gu *GroupUpdate) SetNillableStatus(u *uint8) *GroupUpdate {
	if u != nil {
		gu.SetStatus(*u)
	}
	return gu
...
func (gu *GroupUpdate) AddStatus(u int8) *GroupUpdate {
...
func (gu *GroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := gu.mutation.Status(); ok {
		_spec.SetField(group.FieldStatus, field.TypeUint8, value)
	}
	if value, ok := gu.mutation.AddedStatus(); ok {
		_spec.AddField(group.FieldStatus, field.TypeUint8, value)
	}
	if gu.mutation.StatusCleared() {
		_spec.ClearField(group.FieldStatus, field.TypeUint8)
	}
...
// SetStatus sets the "status" field.
func (guo *GroupUpdateOne) SetStatus(u uint8) *GroupUpdateOne {
...
// SetNillableStatus sets the "status" field if the given value is not nil.
func (guo *GroupUpdateOne) SetNillableStatus(u *uint8) *GroupUpdateOne {
	if u != nil {
		guo.SetStatus(*u)
	}
	return guo
...
// AddStatus adds u to the "status" field.
func (guo *GroupUpdateOne) AddStatus(u int8) *GroupUpdateOne {
