...
var file_load_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6c, 0x6f,
	0x61, 0x64, 0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x17, 0x0a, 0x05, 0x49,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x33, 0x0a, 0x04, 0x4c, 0x6f, 0x61,
	0x64, 0x12, 0x2b, 0x0a, 0x0c, 0x69, 0x6e, 0x69, 0x74, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73,
	0x65, 0x12, 0x0b, 0x2e, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0e,
	0x2e, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x70, 0x42, 0x08,
	0x5a, 0x06, 0x2e, 0x2f, 0x6c, 0x6f, 0x61, 0x64, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_load_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_load_proto_goTypes = []interface{}{
	(*Empty)(nil),        // 0: load.Empty
	(*IDReq)(nil),        // 1: load.IDReq
	(*IDsReq)(nil),       // 2: load.IDsReq
	(*UUIDsReq)(nil),     // 3: load.UUIDsReq
	(*UUIDReq)(nil),      // 4: load.UUIDReq
	(*BaseResp)(nil),     // 5: load.BaseResp
	(*PageInfoReq)(nil),  // 6: load.PageInfoReq
	(*BaseIDResp)(nil),   // 7: load.BaseIDResp
	(*BaseUUIDResp)(nil), // 8: load.BaseUUIDResp
}
var file_load_proto_depIdxs = []int32{
	0, // 0: load.Load.initDatabase:input_type -> load.Empty
	5, // 1: load.Load.initDatabase:output_type -> load.BaseResp
...
func file_load_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_load_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IDsReq); i {
			case 0:
				return &v.state
			case 1:
		...
		file_load_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_load_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_load_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_load_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_load_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_load_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
